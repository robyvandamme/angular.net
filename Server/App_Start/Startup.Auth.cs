...
namespace Server
{
    public partial class Startup
    {
        static Startup()
        {
            ...
            UserManagerFactory = () =>
                new ApplicationUserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext()));
        ...
        public static Func<ApplicationUserManager<ApplicationUser>> UserManagerFactory { get; set; }
